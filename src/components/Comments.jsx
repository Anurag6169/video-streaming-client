...
const Comments = ({ videoId }) => {
  ...
  useEffect(() => {
    const fetchComments = async () => {
      try {
        const res = await axios.get(`https://video-streaming-server-woad.vercel.app//api/comments/${videoId}`);
  ...
  const handleCommentSubmit = async (e) => {
    ...
    try {
      const res = await axios.post("https://video-streaming-server-woad.vercel.app//api/comments", {
