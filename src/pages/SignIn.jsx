...
const SignIn = () => {
  ...
  const handleLogin = async (e) => {
    ...
    dispatch(loginStart());
    try {
      const res = await axios.post("https://video-streaming-server-woad.vercel.app//api/auth/signin", { name, password });
  ...
  const signInWithGoogle = async () => {
    ...
    signInWithPopup(auth, provider)
      .then((result) => {
        axios
          .post("https://video-streaming-server-woad.vercel.app//api/auth/google", {
